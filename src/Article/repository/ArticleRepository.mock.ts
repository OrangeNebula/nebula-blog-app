...
두번째로 생각해볼 수 있는건, 작성하는 코드에 대한 품질이다. 개발자 업무의 본질은 코드이다. 개발자의 순수한 업무를 생각해보면, 코드를 “읽고”, “작성하고” 이고, 이 업무를 잘한다는 의미는 “잘 읽고”, “잘 작성하고” 로 환원된다. “잘 작성” 한다는건 적시에 높은 품질의 코드를 만드는 행위로 생각해볼 수 있는데, 이렇게 보면 시니어 개발자는 어떤 코드를 작성하느냐의 측면으로 보는것도 일리가 있다고 생각한다. 그러나 이 역시 절대적인 기준으로 생각해볼 수 있는지에 대해서는 조심해야 한다. 개발자의 업무전선을 잘 살펴보면 요구되는 역량은 코드 이외에도 많이 있다. 개발자는 적극적으로 커뮤니케이션 하고, 조직 상황을 이해하고, 개발사항을 검토하고, 서비스를 모니터링하고, 운영업무를 지원하는 등, 다양한 업무를 진행하기 때문이다. 따라서 “시니어 개발자는 좋은 코드를 작성하는 사람이다.” 라고 생각하기에는 개발자의 업무를 너무 단순화해서 생각한 정의가 될 수 있다. 특히 빠르게 성장하고, 생존을 고민하는 스타트업 입장에서 코드 품질에 대한 고민을 할 여유가 없을 때가 많다. 개발자가 생존에 직결된 업무는 뒷전에 둔 채 코드 품질만 고민하고 있다면 높은 확률로 조직의 상황을 잘 이해하고 있지 않을것 같고, 조직에서 기대하는 “시니어 개발자”의 모습은 아니라고 생각한다.
